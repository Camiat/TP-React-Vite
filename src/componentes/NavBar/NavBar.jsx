  ...
  return (
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        ...
        <img style={{width:'45px'}} src={movieIcon} />
        </NavLink>
        <NavLink style={{textDecoration:'none'}}  to='/'>
        <Navbar.Brand onClick={handleClick} className="texto">SpaceMovie</Navbar.Brand>
        </NavLink>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <NavLink to= "/favoritos" style={{color:"black", textDecoration:"none"}} 
              className="favoritos"> Mis Favoritos</NavLink>
            </Nav.Link>
          ...
          >
            ...
            />
                ...
                <Button variant="outline-success" className='btn' onClick={handleSearch}>Buscar</Button>
