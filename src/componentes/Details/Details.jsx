    ...
    return (
        <>
            ...
            <div className='container-details'>
                ...
                {
                    imageDetails.backdrops.slice(0, 1).map(image => <img className='background' src={`https://image.tmdb.org/t/p/w500/${image.file_path}`} />)
                }
                {
                    imageDetails.posters.slice(0, 1).map(image => <img className='poster' src={`https://image.tmdb.org/t/p/w500/${image.file_path}`} />)
                }
                ...
                <div className='container-description'>
                    ...
                    <div className='favoritos'>
                        {peliFav ? <button onClick={borrarFavoritos} className='fav' >Delete Favourite <img className='heart' src={deleteFav} /> </button> : <button onClick={agregarAFavoritos} className='fav'>Add Favourites <img className='heart' src={addFav} /></button>}
                        <button onClick={abrirTrailer} className='trailer'> Play Trailer <img className='play' style={{ width: "18px" }} src={trailer} /></button>
                    </div>
